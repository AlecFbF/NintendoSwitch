...
//animate in text (x2)
  ...
  TweenMax.from(mc_title_1.children[0], 0.5, {ease: Expo.easeOut, x:"+=200", delay:0});
 TweenMax.from(mc_title_1.children[1], 0.5, {ease: Expo.easeOut, x:"+=200", delay:0.2});
 ...
 TweenMax.from(mc_title_1.children[3], 0.5, {ease: Expo.easeOut, x:"+=200",alpha:0, delay:2.0});
 TweenMax.from(mc_title_1.children[4], 0.5, {ease: Expo.easeOut, x:"+=200", alpha:0,delay:2.2});
...
//fade out copy
 ...
 TweenMax.to(mc_title_1.children[4], 0.5, {alpha:0, delay:0});
